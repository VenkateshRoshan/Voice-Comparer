                            ...
                            MDCard :
                                BoxLayout :
                                    ...
                                    MDLabel :
                                        ...
                                        theme_text_color : 'Primary'
                                    MDLabel :
                                        text : " • Attach File ( *only .wav containing more than 1 min accepted )"
                                        theme_text_color : 'Primary'
                        BoxLayout:
                            MDCard :
                                BoxLayout :
                            ...
                            MDCard :
                                BoxLayout :
                                    ...
                                    MDLabel :
                                        ...
                                        theme_text_color : 'Primary'
                                    MDLabel :
                                        text : " • Attached audio file ( *only .wav containing more than 1 min accepted ) "
                                        theme_text_color : 'Primary'
                        BoxLayout:
                            MDCard :
                                BoxLayout :
...
class KitchenSink(App):
    ...
    def get_MFCC(self,i,rate,audio):
    ...
    def Compare_Res(self,StudId,Test_File) :
        ...
        batch_size = 10
        for i in path :
            data , sr = librosa.load(i,sr=sr,duration=duration,res_type='kaiser_best')
        ...
        for i in path :
            ...
            if count == len(path) :
                gmm = GMM(n_components = 16, n_iter = 100, covariance_type='diag',n_init = 3)
                gmm.fit(features)
